...
function admin_menu(){
    add_menu_page( 'GuestFront Reservation Engine Plugin', 'GuestFront', 'administrator', 'guestfront-dashboard', array($this, 'dashboard'), plugins_url( 'guestfront/images/icon.png') ); 
}
